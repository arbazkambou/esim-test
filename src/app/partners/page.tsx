...
function Page() {
  const cardsData = [
    ...
    },
    {
      ...
      body: "Track your sales, customer activity, usage trends, and customer experience all in one place with our reseller dashboard.",
  ...
  const accordionsData = [
    ...
    },
    {
      ...
      body: "Most newer smartphones, as well as iPads, and many other devices are now eSIM ready. Check the eSIM Device List to see if your devices are compatible.",
    },
  ];
