import DataVoiceGlobalPackagesSection from "@/components/features/packages/global/DataVoiceGlobalPackagesSection";
  ...
  return (
    <>
      ...
      <section className="container mt-16">
        <DataVoiceGlobalPackagesSection packages={globalPackages} />
      </section>
      {/* advantages card  */}
      <section className="container mt-16">
