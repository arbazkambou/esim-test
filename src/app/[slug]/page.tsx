import DataVoiceCountryPackagesSection from "@/components/features/packages/country/DataVoiceCountryPackagesSection";
...
//   const limitedCountries = response.slice(1, 10);

//   return limitedCountries.map((item) => ({ slug: item.slug }));
// }
...
async function Page({ params }: { params: { slug: string } }) {
  ...
  let packages: CountryPackagesMeta;
  ...
  return (
    <section className="container mt-16">
      <section className="mt-16">
        <DataVoiceCountryPackagesSection packages={packages} />
      </section>
      <EsimSteps />
