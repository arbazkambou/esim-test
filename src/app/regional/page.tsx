...
import Regions from "@/components/my-components/data-fetching/RegionsWithDataOnly";
...
import WhyRegionalEsim from "@/components/my-components/presentational/WhyRegionalEsim";
...
export async function generateMetadata({
  ...
  return localizedSeo.regionalEsim;
}
  ...
  return (
    <>
      <CountryRegionsHero
        heading={
          <>
            Regional eSIM: Your Travel &
            <span className="mt-2 inline xl:block">Business Connection</span>
          </>
        }
        description="eSIM - Fast and Affordable mode of Connectivity"
        imageSrc={regionalHero}
      />
