import FaqPageAccordions from "@/components/my-components/accordions/FaqPageAccordions";
  ...
  return (
    <>
      <PagesHero
        ...
        description=" Build your website, app, or business with our eSIM API for resellers
            and developers. Access eSIM Card’s data plans, purchase on demand,
            and sell. Get API & partner with eSIM Card today"
      />
