...
import { DataVoiceUsage } from "@/types/purchase/SimUsage";
...
export default function DataVoiceUsageChart({
  ...
  const isUnlimitedData = initial_data_quantity === -1;
  const isUnlimitedMinutes = initial_minutes === -1;
  const isUnlimitedSms = initial_sms === -1;
