  ...
  return (
    <>
      ...
      <div className="mt-2 flex items-center gap-6">
        ...
        />
        <p className="text-start text-base font-500 leading-none xl:text-body-lg xl:leading-normal">
          {packageName}
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3.5">
        <div
          className={`grid gap-4 ${filteredCoverage.length > 2 && "xl:grid-cols-2"} h-full shrink-0`}
        >
