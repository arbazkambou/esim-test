...
import { getContinentsThatHaveDataVoicePackages } from "@/services/packages/dataVoicePackages";

async function RegionsWithDataVoice() {
  const regions = await getContinentsThatHaveDataVoicePackages();
...
export default RegionsWithDataVoice;
