...
import globalSvg from "@/_assets/svgs/globalMap.svg";
...
function GlobalPackageDetailModal({
  packageDetail,
}: {
  packageDetail: CountryPackage | GlobalPackage;
}) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="barMini flex max-h-[99vh] flex-col gap-3 overflow-auto sm:gap-6"
      ...
      >
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            />
            <p className="text-body-lg font-500">{packageDetail.name}</p>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="barMini max-h-[220px] min-h-[220px] overflow-auto rounded-[0.6rem] border bg-secondary p-4">
                    ...
                    {item.country_coverage.map((countryCoverage, index) => (
                      ...
                      >
                        ...
                        <p className="rounded-[0.6rem] bg-primary-accent px-1">
                          {countryCoverage.t_2G && "2G"}
                          {countryCoverage.th_3G && ",3G"}
                          {countryCoverage["for-4G"] && ",4G"}
                          {countryCoverage.fiv_5G && ",5G"}
                        </p>
                      </div>
                    ))}
                  </div>
...
export default GlobalPackageDetailModal;
