...
import DataVoicePackageCard from "../country/DataVoicePackageCard";

function DataVoiceGlobalPackagesList({
  packages,
}: {
  ...
  const isUnlimitedPackages = packages.find((item) => item.unlimited === true);
  return (
    <div className="grid gap-x-16 gap-y-10 xl:grid-cols-2">
      ...
      <div className="flex flex-col gap-[2rem]">
        ...
        <Tabs defaultValue="1" className="flex w-full justify-center">
          <TabsList className="barMini flex w-[340px] items-center justify-between gap-2 overflow-x-auto pb-3 xs:w-[400px] sm:w-full">
            <TabsTrigger value="1" className="w-full px-3 py-3">
              Feature
            </TabsTrigger>
            <TabsTrigger value="2" className="w-full px-3 py-3">
              Description
            </TabsTrigger>
            <TabsTrigger value="3" className="w-full px-3 py-3">
              Compatibility
            </TabsTrigger>
            <TabsTrigger value="4" className="w-full px-3 py-3">
              Technical Specs
            </TabsTrigger>
          </TabsList>
        </Tabs>
...
export default DataVoiceGlobalPackagesList;
