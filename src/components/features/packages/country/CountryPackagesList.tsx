...
function CountryPackagesList({ packages }: { packages: CountryPackagesMeta }) {
      ...
      <div>
        <div>
          ...
          <div className="relative hidden w-full xl:flex xl:h-[655px]">
            <Image src={countryImg} fill sizes="auto" alt="country image" />
