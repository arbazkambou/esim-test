...
function SocialLogins() {
  return (
    <div className="flex items-center justify-between gap-4 text-sm font-500 text-foreground-light">
      <Button variant={"outline"} className="w-full">
        <Image height={20} width={20} alt="sign in with google" src={google} />
        Google
      </Button>
      <Button variant={"outline"} className="w-full">
        <Image
