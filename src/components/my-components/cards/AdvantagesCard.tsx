...
function AdvantagesCard({
  ...
  return (
    <Reveal variants={cardVariantPrimary} custom={index}>
      <Card className="flex h-full flex-col gap-[0.81rem] rounded-md border border-transparent px-[1.5rem] pb-[1.88rem] pt-[2.38rem] shadow-myCard transition-all hover:scale-105 hover:cursor-pointer hover:border-primary">
