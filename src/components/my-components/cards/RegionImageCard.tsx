...
function RegionImageCard({ name, slug, imgSrc }: PropsType) {
  ...
  return (
    <Link
      ...
      className="w-full"
    >
      <div className="group relative h-[200px] w-full overflow-hidden rounded-[0.625rem] shadow-purple-300 transition-transform hover:scale-105">
        <div className="relative z-30 flex h-full flex-col justify-between text-background">
          <p className="ms-[1.2rem] mt-[0.5rem] text-start text-body-lg font-700">
            {name}
          </p>
