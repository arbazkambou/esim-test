      ...
      <div className="flex flex-col gap-[1.31rem]">
        ...
        <p className="text-center text-body-sm text-muted-foreground md:text-body-md xl:text-start">
          {description ? (
            ...
            <>
              Your Personnel eSIM Carrier for Global Connectivity takes your
              Digital
              <br /> Communication to the next level. Buy Your eSIM Online from
              eSIMCard.
            </>
          )}
        </p>
            ...
            {index % 2 === 0 ? (
              <>
                ...
                >
                  ...
                  <h3 className="text-center font-montserrat text-[1.875rem] font-700 leading-tight text-primary/95 md:text-start md:text-[2.8125rem]">
                    {step.title}
                  </h3>
