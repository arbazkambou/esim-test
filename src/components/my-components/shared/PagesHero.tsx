...
function PagesHero({ title, description, btnLink }: PropsType) {
  return (
    <section className="mb-16 mt-16 xl:container">
      <div className="flex flex-col items-center gap-[1.6rem] bg-primary px-[3.12rem] py-[1.94rem] text-background xl:col-span-1 xl:rounded-[2.5rem]">
